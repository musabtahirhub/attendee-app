...
PROMPT_VERSIONS: Dict[str, str] = {
    "v1.0.0": (
        ...
        "</rules>\n\n"
        "<tools_guidance>\n"
        "- You have access to tools for checking employee status, applying for leave, listing pending leave requests, and approving leave requests.\n"
    ...
    "v1.1.0": (
        ...
        "</rules>\n\n"
        "<tools_guidance>\n"
        "- Available Tools: `check_employee_status`, `apply_employee_leave`, `list_pending_leaves`, `approve_employee_leave`.\n"
