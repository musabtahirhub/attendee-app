...
PROMPT_VERSIONS: Dict[str, str] = {
    "v1.0.0": (
        ...
        "4. If a user asks for a feature that is not supported (e.g., listing all pending leaves), politely inform them in a natural, conversational tone without mentioning internal tools or signatures. Briefly state what actions you can help them with instead.\n"
        "</rules>\n\n"
        "<tools_guidance>\n"
